...
public class ConnectionPool
{
    ...
    private static final String PASSWORD = "1998Danstrupvej";
    private static final String URL = "jdbc:postgresql://165.232.126.75:5432/%s?currentSchema=public";
    private static final String DB = "RootsforRecipes";
